...
void main() {
  group('BitcoinDiamondSigner', () {
    ...
    test('Sign', () {
      ...
      final script0 =
          TWBitcoinScript.lockScriptForAddress(utxoAddr0.description, coin);
      expectHex(
          script0.data, '76a914a48da46386ce52cccad178de900c71f06130c31088ac');
    ...
    test('SignSegwit', () {
      ...
      final script0 =
          TWBitcoinScript.lockScriptForAddress(utxoAddr0.description, coin);
      expectHex(script0.data, '0014a48da46386ce52cccad178de900c71f06130c310');
      input.utxo[0].script = script0.data;
      input.privateKey.add(utxoKey0.data);
    ...
    test('SignAnyoneCanPay', () {
      ...
      final input = Bitcoin.SigningInput(
        hashType: TWBitcoinSigHashType.TWBitcoinSigHashTypeAnyoneCanPay |
    ...
    test('SignWithError', () {
      ...
      // PreImageHash
      final preData = TWTransactionCompiler.preImageHashes(coin, inputData);
      final output = Bitcoin.PreSigningOutput.fromBuffer(preData);

      expect(output.error != Common.SigningError.OK, true);

      // Sign
      final result =
          Bitcoin.SigningOutput.fromBuffer(TWAnySigner.sign(inputData, coin));
