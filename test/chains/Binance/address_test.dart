...
void main() {
  group('BinanceAddress', () {
    ...
    test('AddressToData', () {
      // mainnet
      var data = TWAnyAddress(
              coin: coin, string: 'bnb1h8xf9htasu9aclra954dnnve8fgcda4ae7qfa8')
          .data;
      expectHex(data, 'b9cc92dd7d870bdc7c7d2d2ad9cd993a5186f6bd');

      // testnet
      data = TWAnyAddress(
              coin: TWCoinType.TWCoinTypeTBinance,
              string: 'tbnb1x4hxmtdf7pwea9dghq73dufh3qspm8gp5qht9c')
          .data;
