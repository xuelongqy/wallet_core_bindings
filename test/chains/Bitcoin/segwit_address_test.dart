...
Bech32Codec bech32 = Bech32Codec();
  ...
  group('SegwitAddress', () {
    ...
    test('TestnetAddress', () {
      ...
      // default
      {
        ...
        expect(
            TWSegwitAddress.createWithPublicKey(hrpForString('bc'), pubKey)
                .description,
    ...
    test('SegwitDerivationHDWallet', () {
      ...
      expect(wallet.getAddressForCoin(coin),
          'bc1qpsp72plnsqe6e2dvtsetxtww2cz36ztmfxghpd');
      expect(
          wallet.getAddressDerivation(coin, TWDerivation.TWDerivationDefault),
          'bc1qpsp72plnsqe6e2dvtsetxtww2cz36ztmfxghpd');
      expect(
      ...
      expect(
          wallet.getAddressDerivation(
              coin, TWDerivation.TWDerivationBitcoinLegacy),
          '1GVb4mfQrvymPLz7zeZ3LnQ8sFv3NedZXe');
      expect(
          wallet.getAddressDerivation(
              coin, TWDerivation.TWDerivationBitcoinTestnet),
          'tb1qq8p994ak933c39d2jaj8n4sg598tnkhnyk5sg5');
    });
  });
}
