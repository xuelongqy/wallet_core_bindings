  ...
  group('BitcoinMessageSigner', () {
    ...
    test('SignAndVerify', () {
      ...
      final address = TWBitcoinAddress.createWithPublicKey(
          pubkey, TWCoinTypeP2pkhPrefix(TWCoinType.TWCoinTypeBitcoin));
