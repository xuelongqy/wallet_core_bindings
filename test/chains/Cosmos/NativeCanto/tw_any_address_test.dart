...
final gNativeCantoAddr = "canto14py36sx57ud82t9yrks9z6hdsrpn5x6kl5l2ap";
final gNativeCantoHrp = "canto";

void main() {
  group('TWNativeCantoAnyAddress', () {
    test('AllNativeCantoAddressTests', () {
      final parameters = CosmosAddressParameters(
        hrp: gNativeCantoHrp,
        coinType: TWCoinType.TWCoinTypeNativeCanto,
