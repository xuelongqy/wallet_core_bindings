...
void main() {
  group('TWEthereumSigner', () {
    ...
    test('SignERC20TransferAsERC20', () {
      ...
      final toAddress = "0x5322b34c88ed0691971bf52a7047448f0f4efc84";
      final token = "0x6b175474e89094c44da98b954eedeac495271d0f"; // DAI
    ...
    test('SignERC20TransferAsGenericContract', () {
      ...
      final gasPrice = intToBytes(42000000000); // 0x09c7652400
      final gasLimit = intToBytes(78009); // 130B9
      final toAddress = '0x6b175474e89094c44da98b954eedeac495271d0f'; // DAI
    ...
    test('SignERC20TransferInvalidAddress', () {
      ...
      final gasPrice = intToBytes(42000000000); // 0x09c7652400
      final gasLimit = intToBytes(78009); // 130B9
      final invalidAddress = "0xdeadbeef";
      final amount = bigIntStringToBytes('2000000000000000000');
      final key = parse_hex(
          "0x608dcb1742bb3fb7aec002074e3420e4fab7d00cced79ccdac53ed5b27138151");
    ...
    test('SignERC20Approve', () {
      ...
      final gasPrice = intToBytes(42000000000); // 0x09c7652400
      final gasLimit = intToBytes(78009); // 130B9
      final spenderAddress = '0x5322b34c88ed0691971bf52a7047448f0f4efc84';
      final token = '0x6b175474e89094c44da98b954eedeac495271d0f'; // DAI
      final amount = bigIntStringToBytes('2000000000000000000');
      final key = parse_hex(
          "0x608dcb1742bb3fb7aec002074e3420e4fab7d00cced79ccdac53ed5b27138151");
    ...
    test('SignERC721Transfer', () {
      ...
      final tokenContract = "0x4e45e92ed38f885d39a733c14f1817217a89d425";
      final fromAddress = "0x718046867b5b1782379a14eA4fc0c9b724DA94Fc";
      final toAddress = "0x5322b34c88ed0691971bf52a7047448f0f4efc84";
    ...
    test('SignERC1559Transfer_1442', () {
      ...
      final toAddress = "0xB9F5771C27664bF2282D98E09D7F50cEc7cB01a7";
    ...
    test('StakeRocketPool', () {
      ...
      final toAddress = "0x2cac916b2a963bf162f076c0a8a4a8200bcfbfb4";
      final key = parse_hex(
    ...
    test('UnstakeRocketPool', () {
      ...
      final maxInclusionFeePerGas = intToBytes(1000000000);
      final maxFeePerGas = intToBytes(27900000000);
      final toAddress = "0xae78736Cd615f374D3085123A210448E74Fc6393";
      final key = parse_hex(
          "9f56448d33de406db1561aae15fce64bdf0e9706ff15c45d4409e8fcbfd1a498");
      final pk = TWPrivateKey.createWithData(key);
