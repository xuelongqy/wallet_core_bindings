...
void main() {
  group(TWAES, () {
    test('CBCEncryptZeroPadding', () {
      ...
      expect(TWString.createWithHexData(encryptResult).toString(),
    ...
    test('CBCDecryptZeroPadding', () {
      ...
      expect(TWString.createWithHexData(decryptResult).toString(),
    ...
    test('CTREncrypt', () {
      ...
      final encryptResult = TWAES.encryptCTR(key: key, data: data, iv: iv);
    ...
    test('CBCDecryptPKCS7Padding', () {
      ...
      final decryptResult = TWAES.decryptCTR(key: key, data: cipher, iv: iv);
