...
class TransactionOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set spendingScript($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
...
class UnspentTransaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<TransactionVariant>(
        4, _omitFieldNames ? '' : 'variant', $pb.PbFieldType.OE,
        defaultOrMaker: TransactionVariant.P2PKH,
        valueOf: TransactionVariant.valueOf,
  ...
  @$pb.TagNumber(4)
  set variant(TransactionVariant v) {
    setField(4, v);
  }
...
class SigningInput extends $pb.GeneratedMessage {
  factory SigningInput({
    ...
    if (isItBrcOperation != null) {
      $result.isItBrcOperation = isItBrcOperation;
    }
    if (planningV2 != null) {
      $result.planningV2 = planningV2;
    }
    if (signingV2 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<UnspentTransaction>(
        8, _omitFieldNames ? '' : 'utxo', $pb.PbFieldType.PM,
    ...
    ..pc<OutputAddress>(
        14, _omitFieldNames ? '' : 'extraOutputs', $pb.PbFieldType.PM,
    ...
    ..aOB(18, _omitFieldNames ? '' : 'isItBrcOperation')
    ..aOM<$2.ComposePlan>(20, _omitFieldNames ? '' : 'planningV2',
  ...
  @$pb.TagNumber(16)
  set disableDustFilter($core.bool v) {
    $_setBool(15, v);
  }
  ...
  @$pb.TagNumber(18)
  $core.bool get isItBrcOperation => $_getBF(17);
  @$pb.TagNumber(18)
  set isItBrcOperation($core.bool v) {
    $_setBool(17, v);
  }

  @$pb.TagNumber(18)
  $core.bool hasIsItBrcOperation() => $_has(17);
  @$pb.TagNumber(18)
  void clearIsItBrcOperation() => clearField(18);

  /// If set, uses Bitcoin 2.0 Planning protocol.
  /// As a result, `Bitcoin.Proto.TransactionPlan.planning_result_v2` is set.
  @$pb.TagNumber(20)
  $2.ComposePlan get planningV2 => $_getN(18);
  @$pb.TagNumber(20)
  set planningV2($2.ComposePlan v) {
    setField(20, v);
  }

  @$pb.TagNumber(20)
  $core.bool hasPlanningV2() => $_has(18);
  @$pb.TagNumber(20)
  void clearPlanningV2() => clearField(20);
  @$pb.TagNumber(20)
  $2.ComposePlan ensurePlanningV2() => $_ensure(18);

  /// If set, uses Bitcoin 2.0 Signing protocol.
  /// As a result, `Bitcoin.Proto.SigningOutput.signing_result_v2` is set.
  @$pb.TagNumber(21)
  $2.SigningInput get signingV2 => $_getN(19);
  @$pb.TagNumber(21)
  set signingV2($2.SigningInput v) {
    setField(21, v);
  }

  @$pb.TagNumber(21)
  $core.bool hasSigningV2() => $_has(19);
  @$pb.TagNumber(21)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<UnspentTransaction>(
        5, _omitFieldNames ? '' : 'utxos', $pb.PbFieldType.PM,
        subBuilder: UnspentTransaction.create)
    ..a<$core.List<$core.int>>(
        6, _omitFieldNames ? '' : 'branchId', $pb.PbFieldType.OY)
    ..e<$0.SigningError>(7, _omitFieldNames ? '' : 'error', $pb.PbFieldType.OE,
  ...
  @$pb.TagNumber(9)
  set preblockhash($core.List<$core.int> v) {
    $_setBytes(8, v);
  }
  ...
  @$pb.TagNumber(10)
  set preblockheight($fixnum.Int64 v) {
    $_setInt64(9, v);
  }
  ...
  @$pb.TagNumber(12)
  $2.TransactionPlan get planningResultV2 => $_getN(10);
  @$pb.TagNumber(12)
  set planningResultV2($2.TransactionPlan v) {
    setField(12, v);
  }
...
class SigningOutput extends $pb.GeneratedMessage {
  factory SigningOutput({
    ...
    $2.SigningOutput? signingResultV2,
  }) {
    final $result = create();
    if (transaction != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.SigningOutput>(7, _omitFieldNames ? '' : 'signingResultV2',
        subBuilder: $2.SigningOutput.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  $2.SigningOutput get signingResultV2 => $_getN(5);
  @$pb.TagNumber(7)
  set signingResultV2($2.SigningOutput v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $2.SigningOutput ensureSigningResultV2() => $_ensure(5);
}
...
class PreSigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<HashPublicKey>(
        1, _omitFieldNames ? '' : 'hashPublicKeys', $pb.PbFieldType.PM,
