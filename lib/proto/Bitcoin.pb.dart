...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Bitcoin.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$2.ComposePlan>(20, _omitFieldNames ? '' : 'planningV2', subBuilder: $2.ComposePlan.create)
    ..aOM<$2.SigningInput>(21, _omitFieldNames ? '' : 'signingV2', subBuilder: $2.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(18)
  set isItBrcOperation($core.bool v) { $_setBool(17, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(20)
  set planningV2($2.ComposePlan v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set signingV2($2.SigningInput v) { setField(21, v); }
  @$pb.TagNumber(21)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionPlan', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Bitcoin.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$2.TransactionPlan>(12, _omitFieldNames ? '' : 'planningResultV2', subBuilder: $2.TransactionPlan.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(12)
  set planningResultV2($2.TransactionPlan v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Bitcoin.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$2.SigningOutput>(7, _omitFieldNames ? '' : 'signingResultV2', subBuilder: $2.SigningOutput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set signingResultV2($2.SigningOutput v) { setField(7, v); }
  @$pb.TagNumber(7)
