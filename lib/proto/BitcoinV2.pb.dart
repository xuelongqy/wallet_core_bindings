...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$1.LockTime>(3, _omitFieldNames ? '' : 'lockTime', subBuilder: $1.LockTime.create)
    ...
    ..e<$1.InputSelector>(7, _omitFieldNames ? '' : 'inputSelector', $pb.PbFieldType.OE, defaultOrMaker: $1.InputSelector.UseAll, valueOf: $1.InputSelector.valueOf, enumValues: $1.InputSelector.values)
    ..a<$fixnum.Int64>(8, _omitFieldNames ? '' : 'feePerVb', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$pb.TagNumber(3)
  set lockTime($1.LockTime v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set inputSelector($1.InputSelector v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set feePerVb($fixnum.Int64 v) { $_setInt64(6, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set disableChangeOutput($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set dangerousUseFixedSchnorrRng($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(11)
...
class Input_InputBuilder extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input.InputBuilder', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'p2sh', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'p2pkh', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'p2wsh', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(6, _omitFieldNames ? '' : 'p2wpkh', $pb.PbFieldType.OY)
    ..aOM<Input_InputTaprootKeyPath>(7, _omitFieldNames ? '' : 'p2trKeyPath', subBuilder: Input_InputTaprootKeyPath.create)
    ..aOM<Input_InputTaprootScriptPath>(8, _omitFieldNames ? '' : 'p2trScriptPath', subBuilder: Input_InputTaprootScriptPath.create)
    ..aOM<Input_InputBrc20Inscription>(9, _omitFieldNames ? '' : 'brc20Inscribe', subBuilder: Input_InputBrc20Inscription.create)
    ..aOM<Input_InputOrdinalInscription>(10, _omitFieldNames ? '' : 'ordinalInscribe', subBuilder: Input_InputOrdinalInscription.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set p2sh($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set p2pkh($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set p2wsh($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set p2wpkh($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set p2trKeyPath(Input_InputTaprootKeyPath v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set p2trScriptPath(Input_InputTaprootScriptPath v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set ordinalInscribe(Input_InputOrdinalInscription v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class Input_InputScriptWitness extends $pb.GeneratedMessage {
  ...
  factory Input_InputScriptWitness.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Input_InputScriptWitness.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input.InputScriptWitness', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'scriptPubkey', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'scriptSig', $pb.PbFieldType.OY)
    ..p<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'witnessItems', $pb.PbFieldType.PY)
    ..e<$1.SigningMethod>(5, _omitFieldNames ? '' : 'signingMethod', $pb.PbFieldType.OE, defaultOrMaker: $1.SigningMethod.Legacy, valueOf: $1.SigningMethod.valueOf, enumValues: $1.SigningMethod.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Input_InputScriptWitness clone() => Input_InputScriptWitness()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Input_InputScriptWitness copyWith(void Function(Input_InputScriptWitness) updates) => super.copyWith((message) => updates(message as Input_InputScriptWitness)) as Input_InputScriptWitness;
  ...
  static $pb.PbList<Input_InputScriptWitness> createRepeated() => $pb.PbList<Input_InputScriptWitness>();
  @$core.pragma('dart2js:noInline')
  static Input_InputScriptWitness getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Input_InputScriptWitness>(create);
  ...
  @$pb.TagNumber(2)
  set scriptSig($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set signingMethod($1.SigningMethod v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class Input_InputTaprootKeyPath extends $pb.GeneratedMessage {
  ...
  factory Input_InputTaprootKeyPath.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Input_InputTaprootKeyPath.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input.InputTaprootKeyPath', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Input_InputTaprootKeyPath clone() => Input_InputTaprootKeyPath()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Input_InputTaprootKeyPath copyWith(void Function(Input_InputTaprootKeyPath) updates) => super.copyWith((message) => updates(message as Input_InputTaprootKeyPath)) as Input_InputTaprootKeyPath;
  ...
  static $pb.PbList<Input_InputTaprootKeyPath> createRepeated() => $pb.PbList<Input_InputTaprootKeyPath>();
  @$core.pragma('dart2js:noInline')
  static Input_InputTaprootKeyPath getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Input_InputTaprootKeyPath>(create);
  ...
  @$pb.TagNumber(1)
  set onePrevout($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
...
class Input_InputTaprootScriptPath extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set controlBlock($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
...
class Input_InputOrdinalInscription extends $pb.GeneratedMessage {
  ...
  factory Input_InputOrdinalInscription.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Input_InputOrdinalInscription.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input.InputOrdinalInscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'onePrevout')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Input_InputOrdinalInscription clone() => Input_InputOrdinalInscription()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Input_InputOrdinalInscription copyWith(void Function(Input_InputOrdinalInscription) updates) => super.copyWith((message) => updates(message as Input_InputOrdinalInscription)) as Input_InputOrdinalInscription;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Input_InputOrdinalInscription create() => Input_InputOrdinalInscription._();
  Input_InputOrdinalInscription createEmptyInstance() => create();
  static $pb.PbList<Input_InputOrdinalInscription> createRepeated() => $pb.PbList<Input_InputOrdinalInscription>();
  @$core.pragma('dart2js:noInline')
  static Input_InputOrdinalInscription getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Input_InputOrdinalInscription>(create);
  ...
  @$pb.TagNumber(2)
  set inscribeTo($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
...
class Input_InputBrc20Inscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input.InputBrc20Inscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'transferAmount', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set transferAmount($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
...
class Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..e<$1.SighashType>(7, _omitFieldNames ? '' : 'sighashType', $pb.PbFieldType.OE, defaultOrMaker: $1.SighashType.UseDefault, valueOf: $1.SighashType.valueOf, enumValues: $1.SighashType.values)
    ..aOM<Input_InputBuilder>(8, _omitFieldNames ? '' : 'builder', subBuilder: Input_InputBuilder.create)
    ..aOM<Input_InputScriptWitness>(9, _omitFieldNames ? '' : 'customScript', subBuilder: Input_InputScriptWitness.create)
    ..hasRequiredFields = false
  ;
  ...
  Input_ToRecipient whichToRecipient() => _Input_ToRecipientByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set vout($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set sequenceEnableZero($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set sighashType($1.SighashType v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set builder(Input_InputBuilder v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set customScript(Input_InputScriptWitness v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class Output_OutputBuilder extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output.OutputBuilder', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..aOM<Output_OutputRedeemScriptOrHash>(1, _omitFieldNames ? '' : 'p2sh', subBuilder: Output_OutputRedeemScriptOrHash.create)
    ..aOM<ToPublicKeyOrHash>(2, _omitFieldNames ? '' : 'p2pkh', subBuilder: ToPublicKeyOrHash.create)
    ..aOM<Output_OutputRedeemScriptOrHash>(3, _omitFieldNames ? '' : 'p2wsh', subBuilder: Output_OutputRedeemScriptOrHash.create)
    ..aOM<ToPublicKeyOrHash>(4, _omitFieldNames ? '' : 'p2wpkh', subBuilder: ToPublicKeyOrHash.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'p2trKeyPath', $pb.PbFieldType.OY)
    ..aOM<Output_OutputTaprootScriptPath>(6, _omitFieldNames ? '' : 'p2trScriptPath', subBuilder: Output_OutputTaprootScriptPath.create)
    ..a<$core.List<$core.int>>(7, _omitFieldNames ? '' : 'p2trDangerousAssumeTweaked', $pb.PbFieldType.OY)
    ..aOM<Output_OutputBrc20Inscription>(8, _omitFieldNames ? '' : 'brc20Inscribe', subBuilder: Output_OutputBrc20Inscription.create)
    ..aOM<Output_OutputOrdinalInscription>(9, _omitFieldNames ? '' : 'ordinalInscribe', subBuilder: Output_OutputOrdinalInscription.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set p2sh(Output_OutputRedeemScriptOrHash v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasP2sh() => $_has(0);
  @$pb.TagNumber(1)
  void clearP2sh() => clearField(1);
  ...
  @$pb.TagNumber(2)
  set p2pkh(ToPublicKeyOrHash v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasP2pkh() => $_has(1);
  @$pb.TagNumber(2)
  void clearP2pkh() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set p2wsh(Output_OutputRedeemScriptOrHash v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasP2wsh() => $_has(2);
  @$pb.TagNumber(3)
  void clearP2wsh() => clearField(3);
  ...
  @$pb.TagNumber(4)
  set p2wpkh(ToPublicKeyOrHash v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasP2wpkh() => $_has(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set p2trKeyPath($core.List<$core.int> v) { $_setBytes(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasP2trKeyPath() => $_has(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set p2trScriptPath(Output_OutputTaprootScriptPath v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasP2trScriptPath() => $_has(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set p2trDangerousAssumeTweaked($core.List<$core.int> v) { $_setBytes(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set brc20Inscribe(Output_OutputBrc20Inscription v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set ordinalInscribe(Output_OutputOrdinalInscription v) { setField(9, v); }
  @$pb.TagNumber(9)
...
enum Output_OutputRedeemScriptOrHash_Variant {
  redeemScript, 
  hash, 
  notSet
}
...
class Output_OutputRedeemScriptOrHash extends $pb.GeneratedMessage {
  ...
  factory Output_OutputRedeemScriptOrHash.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Output_OutputRedeemScriptOrHash.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, Output_OutputRedeemScriptOrHash_Variant> _Output_OutputRedeemScriptOrHash_VariantByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output.OutputRedeemScriptOrHash', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..oo(0, [1, 2])
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Output_OutputRedeemScriptOrHash clone() => Output_OutputRedeemScriptOrHash()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Output_OutputRedeemScriptOrHash copyWith(void Function(Output_OutputRedeemScriptOrHash) updates) => super.copyWith((message) => updates(message as Output_OutputRedeemScriptOrHash)) as Output_OutputRedeemScriptOrHash;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Output_OutputRedeemScriptOrHash create() => Output_OutputRedeemScriptOrHash._();
  Output_OutputRedeemScriptOrHash createEmptyInstance() => create();
  static $pb.PbList<Output_OutputRedeemScriptOrHash> createRepeated() => $pb.PbList<Output_OutputRedeemScriptOrHash>();
  @$core.pragma('dart2js:noInline')
  static Output_OutputRedeemScriptOrHash getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Output_OutputRedeemScriptOrHash>(create);
  static Output_OutputRedeemScriptOrHash? _defaultInstance;

  Output_OutputRedeemScriptOrHash_Variant whichVariant() => _Output_OutputRedeemScriptOrHash_VariantByTag[$_whichOneof(0)]!;
  void clearVariant() => clearField($_whichOneof(0));
...
class Output_OutputOrdinalInscription extends $pb.GeneratedMessage {
  ...
  factory Output_OutputOrdinalInscription.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Output_OutputOrdinalInscription.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output.OutputOrdinalInscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Output_OutputOrdinalInscription clone() => Output_OutputOrdinalInscription()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Output_OutputOrdinalInscription copyWith(void Function(Output_OutputOrdinalInscription) updates) => super.copyWith((message) => updates(message as Output_OutputOrdinalInscription)) as Output_OutputOrdinalInscription;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Output_OutputOrdinalInscription create() => Output_OutputOrdinalInscription._();
  Output_OutputOrdinalInscription createEmptyInstance() => create();
  static $pb.PbList<Output_OutputOrdinalInscription> createRepeated() => $pb.PbList<Output_OutputOrdinalInscription>();
  @$core.pragma('dart2js:noInline')
  static Output_OutputOrdinalInscription getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Output_OutputOrdinalInscription>(create);
...
class Output_OutputBrc20Inscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output.OutputBrc20Inscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'transferAmount', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set transferAmount($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
...
enum ToPublicKeyOrHash_ToAddress {
  pubkey, 
  hash, 
  notSet
}
...
class ToPublicKeyOrHash extends $pb.GeneratedMessage {
  ...
  factory ToPublicKeyOrHash.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ToPublicKeyOrHash.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ToPublicKeyOrHash_ToAddress> _ToPublicKeyOrHash_ToAddressByTag = {
    1 : ToPublicKeyOrHash_ToAddress.pubkey,
    2 : ToPublicKeyOrHash_ToAddress.hash,
    0 : ToPublicKeyOrHash_ToAddress.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ToPublicKeyOrHash', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..oo(0, [1, 2])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ToPublicKeyOrHash copyWith(void Function(ToPublicKeyOrHash) updates) => super.copyWith((message) => updates(message as ToPublicKeyOrHash)) as ToPublicKeyOrHash;
  ...
  static $pb.PbList<ToPublicKeyOrHash> createRepeated() => $pb.PbList<ToPublicKeyOrHash>();
  @$core.pragma('dart2js:noInline')
  static ToPublicKeyOrHash getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ToPublicKeyOrHash>(create);
  static ToPublicKeyOrHash? _defaultInstance;

  ToPublicKeyOrHash_ToAddress whichToAddress() => _ToPublicKeyOrHash_ToAddressByTag[$_whichOneof(0)]!;
...
class PreSigningOutput_TxOut extends $pb.GeneratedMessage {
  ...
  factory PreSigningOutput_TxOut.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PreSigningOutput_TxOut.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PreSigningOutput.TxOut', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'scriptPubkey', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'taprootPayload', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'controlBlock', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PreSigningOutput_TxOut clone() => PreSigningOutput_TxOut()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PreSigningOutput_TxOut copyWith(void Function(PreSigningOutput_TxOut) updates) => super.copyWith((message) => updates(message as PreSigningOutput_TxOut)) as PreSigningOutput_TxOut;
  ...
  static $pb.PbList<PreSigningOutput_TxOut> createRepeated() => $pb.PbList<PreSigningOutput_TxOut>();
  @$core.pragma('dart2js:noInline')
  static PreSigningOutput_TxOut getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PreSigningOutput_TxOut>(create);
  ...
  @$pb.TagNumber(3)
  set taprootPayload($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set controlBlock($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
...
class PreSigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PreSigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..e<Error>(1, _omitFieldNames ? '' : 'error', $pb.PbFieldType.OE, defaultOrMaker: Error.OK, valueOf: Error.valueOf, enumValues: Error.values)
    ..aOS(2, _omitFieldNames ? '' : 'errorMessage')
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'txid', $pb.PbFieldType.OY)
    ..pc<$1.Sighash>(4, _omitFieldNames ? '' : 'sighashes', $pb.PbFieldType.PM, subBuilder: $1.Sighash.create)
    ..pc<$1.TxIn>(5, _omitFieldNames ? '' : 'utxoInputs', $pb.PbFieldType.PM, subBuilder: $1.TxIn.create)
    ..pc<PreSigningOutput_TxOut>(6, _omitFieldNames ? '' : 'utxoOutputs', $pb.PbFieldType.PM, subBuilder: PreSigningOutput_TxOut.create)
    ..a<$fixnum.Int64>(7, _omitFieldNames ? '' : 'weightEstimate', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(8, _omitFieldNames ? '' : 'feeEstimate', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set weightEstimate($fixnum.Int64 v) { $_setInt64(6, v); }
  @$pb.TagNumber(7)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'weight', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
...
class Transaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'version', $pb.PbFieldType.O3)
    ..aOM<$1.LockTime>(2, _omitFieldNames ? '' : 'lockTime', subBuilder: $1.LockTime.create)
  ...
  @$pb.TagNumber(2)
  set lockTime($1.LockTime v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TransactionInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'txid', $pb.PbFieldType.OY)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'vout', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'sequence', $pb.PbFieldType.OU3)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'scriptSig', $pb.PbFieldType.OY)
    ..p<$core.List<$core.int>>(6, _omitFieldNames ? '' : 'witnessItems', $pb.PbFieldType.PY)
    ..hasRequiredFields = false
  ;
...
class TransactionOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'scriptPubkey', $pb.PbFieldType.OY)
...
class ComposePlan_ComposeBrc20Plan extends $pb.GeneratedMessage {
  ...
  factory ComposePlan_ComposeBrc20Plan.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ComposePlan_ComposeBrc20Plan.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComposePlan.ComposeBrc20Plan', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'privateKey', $pb.PbFieldType.OY)
    ..pc<Input>(2, _omitFieldNames ? '' : 'inputs', $pb.PbFieldType.PM, subBuilder: Input.create)
    ..e<$1.InputSelector>(3, _omitFieldNames ? '' : 'inputSelector', $pb.PbFieldType.OE, defaultOrMaker: $1.InputSelector.UseAll, valueOf: $1.InputSelector.valueOf, enumValues: $1.InputSelector.values)
    ..aOM<Output>(4, _omitFieldNames ? '' : 'taggedOutput', subBuilder: Output.create)
    ..aOM<Input_InputBrc20Inscription>(5, _omitFieldNames ? '' : 'inscription', subBuilder: Input_InputBrc20Inscription.create)
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'feePerVb', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ComposePlan_ComposeBrc20Plan clone() => ComposePlan_ComposeBrc20Plan()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ComposePlan_ComposeBrc20Plan copyWith(void Function(ComposePlan_ComposeBrc20Plan) updates) => super.copyWith((message) => updates(message as ComposePlan_ComposeBrc20Plan)) as ComposePlan_ComposeBrc20Plan;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ComposePlan_ComposeBrc20Plan create() => ComposePlan_ComposeBrc20Plan._();
  ComposePlan_ComposeBrc20Plan createEmptyInstance() => create();
  static $pb.PbList<ComposePlan_ComposeBrc20Plan> createRepeated() => $pb.PbList<ComposePlan_ComposeBrc20Plan>();
  @$core.pragma('dart2js:noInline')
  static ComposePlan_ComposeBrc20Plan getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ComposePlan_ComposeBrc20Plan>(create);
  ...
  @$pb.TagNumber(3)
  set inputSelector($1.InputSelector v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set taggedOutput(Output v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set inscription(Input_InputBrc20Inscription v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set disableChangeOutput($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
...
class ComposePlan extends $pb.GeneratedMessage {
  ...
  ComposePlan._() : super();
  factory ComposePlan.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ComposePlan.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ComposePlan_Compose> _ComposePlan_ComposeByTag = {
    1 : ComposePlan_Compose.brc20,
    0 : ComposePlan_Compose.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComposePlan', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<ComposePlan_ComposeBrc20Plan>(1, _omitFieldNames ? '' : 'brc20', subBuilder: ComposePlan_ComposeBrc20Plan.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ComposePlan copyWith(void Function(ComposePlan) updates) => super.copyWith((message) => updates(message as ComposePlan)) as ComposePlan;
  ...
  @$core.pragma('dart2js:noInline')
  static ComposePlan getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ComposePlan>(create);
  static ComposePlan? _defaultInstance;

  ComposePlan_Compose whichCompose() => _ComposePlan_ComposeByTag[$_whichOneof(0)]!;
  void clearCompose() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  ComposePlan_ComposeBrc20Plan get brc20 => $_getN(0);
  @$pb.TagNumber(1)
  set brc20(ComposePlan_ComposeBrc20Plan v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class TransactionPlan_Brc20Plan extends $pb.GeneratedMessage {
  ...
  factory TransactionPlan_Brc20Plan.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TransactionPlan_Brc20Plan.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionPlan.Brc20Plan', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..aOM<SigningInput>(1, _omitFieldNames ? '' : 'commit', subBuilder: SigningInput.create)
    ..aOM<SigningInput>(2, _omitFieldNames ? '' : 'reveal', subBuilder: SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TransactionPlan_Brc20Plan clone() => TransactionPlan_Brc20Plan()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransactionPlan_Brc20Plan copyWith(void Function(TransactionPlan_Brc20Plan) updates) => super.copyWith((message) => updates(message as TransactionPlan_Brc20Plan)) as TransactionPlan_Brc20Plan;
  ...
  static $pb.PbList<TransactionPlan_Brc20Plan> createRepeated() => $pb.PbList<TransactionPlan_Brc20Plan>();
  @$core.pragma('dart2js:noInline')
  static TransactionPlan_Brc20Plan getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TransactionPlan_Brc20Plan>(create);
  static TransactionPlan_Brc20Plan? _defaultInstance;

  @$pb.TagNumber(1)
  SigningInput get commit => $_getN(0);
  @$pb.TagNumber(1)
  set commit(SigningInput v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set reveal(SigningInput v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, TransactionPlan_Plan> _TransactionPlan_PlanByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionPlan', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ...
    ..e<Error>(1, _omitFieldNames ? '' : 'error', $pb.PbFieldType.OE, defaultOrMaker: Error.OK, valueOf: Error.valueOf, enumValues: Error.values)
    ..aOS(2, _omitFieldNames ? '' : 'errorMessage')
    ..aOM<TransactionPlan_Brc20Plan>(3, _omitFieldNames ? '' : 'brc20', subBuilder: TransactionPlan_Brc20Plan.create)
    ..hasRequiredFields = false
  ;
  ...
  TransactionPlan_Plan whichPlan() => _TransactionPlan_PlanByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set brc20(TransactionPlan_Brc20Plan v) { setField(3, v); }
  @$pb.TagNumber(3)
