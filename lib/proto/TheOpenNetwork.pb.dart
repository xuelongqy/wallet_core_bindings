...
class JettonTransfer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'queryId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        3, _omitFieldNames ? '' : 'jettonAmount', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(4, _omitFieldNames ? '' : 'toOwner')
    ..aOS(5, _omitFieldNames ? '' : 'responseAddress')
    ..a<$fixnum.Int64>(
        6, _omitFieldNames ? '' : 'forwardAmount', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
...
enum SigningInput_ActionOneof { transfer, jettonTransfer, notSet }
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Transfer>(2, _omitFieldNames ? '' : 'transfer',
        subBuilder: Transfer.create)
    ..aOM<JettonTransfer>(3, _omitFieldNames ? '' : 'jettonTransfer',
