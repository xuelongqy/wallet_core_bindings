  ...
  group('Litecoin', () {
    ...
    test('ExtendedKeys', () {
      ...
      final lptv = wallet.getExtendedPrivateKey(
        ...
        coin: coin,
        version: TWHDVersion.LTPV,
      );
      final ltub = wallet.getExtendedPublicKey(
        purpose: TWPurpose.BIP44,
        coin: coin,
        version: TWHDVersion.LTUB,
      );
      ...
      final mptv = wallet.getExtendedPrivateKey(
        ...
        coin: coin,
        version: TWHDVersion.MTPV,
      );
      final mtub = wallet.getExtendedPublicKey(
        purpose: TWPurpose.BIP49,
        coin: coin,
        version: TWHDVersion.MTUB,
      );
    ...
    test('DeriveFromZpub', () {
      ...
      final pubKey4 = TWHDWallet.getPublicKeyFromExtended(
        extended: zpub,
        coin: coin,
        derivationPath: "m/44'/2'/0'/0/4",
      );
      final pubKey11 = TWHDWallet.getPublicKeyFromExtended(
        extended: zpub,
        coin: coin,
        derivationPath: "m/44'/2'/0'/0/11",
      );
