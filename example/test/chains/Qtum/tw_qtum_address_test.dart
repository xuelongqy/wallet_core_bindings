...
void main() {
  ...
  group('Qtum', () {
    ...
    test('Address', () {
      ...
      final publicKey = privateKey.getPublicKeySecp256k1(true);
      final address =
          TWSegwitAddress.createWithPublicKey(TWHRP.Qtum, publicKey);
      final addressString = address.description;
    ...
    test('DeriveFromZpub', () {
      ...
      final address4 = TWSegwitAddress.createWithPublicKey(TWHRP.Qtum, pubKey4);
      final address4String = address4.description;

      final address11 =
          TWSegwitAddress.createWithPublicKey(TWHRP.Qtum, pubKey11);
