...
class TWCoinTypeConfiguration {
  ...
  static String getSymbol(TWCoinType type) =>
      TWString.fromPointer(_coinTypeConfigurationImpl.getSymbol(type.coin))
          .value!;
  ...
  static int getDecimals(TWCoinType type) =>
      _coinTypeConfigurationImpl.getDecimals(type.coin);
  ...
  static String getID(TWCoinType type) =>
      TWString.fromPointer(_coinTypeConfigurationImpl.getID(type.coin)).value!;
  ...
  static String getName(TWCoinType type) =>
      TWString.fromPointer(_coinTypeConfigurationImpl.getName(type.coin))
          .value!;
}
