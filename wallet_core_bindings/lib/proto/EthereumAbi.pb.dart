...
class ParamType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set byteArrayFix(ByteArrayFixType v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(15)
  set fixedArray(FixedArrayType v) {
    setField(15, v);
  }
...
class Token extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set byteArray($core.List<$core.int> v) {
    $_setBytes(6, v);
  }
  ...
  @$pb.TagNumber(10)
  set byteArrayFix($core.List<$core.int> v) {
    $_setBytes(7, v);
  }
...
class ContractCallDecodingOutput extends $pb.GeneratedMessage {
  ...
  factory ContractCallDecodingOutput.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractCallDecodingOutput.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class FunctionEncodingOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set functionType($core.String v) {
    $_setString(0, v);
  }
