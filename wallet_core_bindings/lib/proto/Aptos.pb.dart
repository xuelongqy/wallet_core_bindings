...
class OfferNftMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set propertyVersion($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
...
class NftMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set offerNft(OfferNftMessage v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set cancelOfferNft(CancelOfferNftMessage v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set claimNft(ClaimNftMessage v) {
    setField(3, v);
  }
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set expirationTimestampSecs($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(10)
  set tokenTransfer(TokenTransferMessage v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(11)
  set createAccount(CreateAccountMessage v) {
    setField(11, v);
  }
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set rawTxn($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
