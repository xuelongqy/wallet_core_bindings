...
class TransactionVersion extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, TransactionVersion> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class PreSigningOutput_SigningMethod extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, PreSigningOutput_SigningMethod> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static PreSigningOutput_SigningMethod? valueOf($core.int value) =>
      _byValue[value];

  const PreSigningOutput_SigningMethod._($core.int v, $core.String n)
      : super(v, n);
}
