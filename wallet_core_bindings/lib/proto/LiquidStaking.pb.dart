...
class Unstake extends $pb.GeneratedMessage {
  ...
  Unstake._() : super();
  factory Unstake.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Unstake.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$pb.TagNumber(4)
  set receiverChainId($core.String v) {
    $_setString(3, v);
  }
...
class Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Protocol>(5, _omitFieldNames ? '' : 'protocol', $pb.PbFieldType.OE,
        defaultOrMaker: Protocol.Strader,
        valueOf: Protocol.valueOf,
        enumValues: Protocol.values)
    ..e<Blockchain>(6, _omitFieldNames ? '' : 'blockchain', $pb.PbFieldType.OE,
        defaultOrMaker: Blockchain.ETHEREUM,
        valueOf: Blockchain.valueOf,
...
class Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.SigningInput>(2, _omitFieldNames ? '' : 'ethereum',
        subBuilder: $7.SigningInput.create)
    ..aOM<$8.SigningInput>(3, _omitFieldNames ? '' : 'cosmos',
        subBuilder: $8.SigningInput.create)
    ..aOM<$9.SigningInput>(4, _omitFieldNames ? '' : 'aptos',
        subBuilder: $9.SigningInput.create)
    ..hasRequiredFields = false;
