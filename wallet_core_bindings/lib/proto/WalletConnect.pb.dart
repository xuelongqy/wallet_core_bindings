...
class ParseRequestOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$9.SigningInput>(3, _omitFieldNames ? '' : 'binance',
        subBuilder: $9.SigningInput.create)
    ..aOM<$10.SigningInput>(4, _omitFieldNames ? '' : 'solana',
  ...
  @$pb.TagNumber(3)
  $9.SigningInput get binance => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $9.SigningInput ensureBinance() => $_ensure(2);

  @$pb.TagNumber(4)
  $10.SigningInput get solana => $_getN(3);
  @$pb.TagNumber(4)
  set solana($10.SigningInput v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $10.SigningInput ensureSolana() => $_ensure(3);
}
