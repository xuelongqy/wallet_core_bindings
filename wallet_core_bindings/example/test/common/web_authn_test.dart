...
void main() {
  ...
  group(TWWebAuthn, () {
    ...
    test('GetPublicKeyBufferOverflow', () {
      // AuthData length is 36 bytes (expected at least 37).
      {
        const attestationHex =
            '0xa16861757468446174615824f95bc73828ee210f9fd3bbe72d97908013b0a3759e9aea3d0ae318766cd2e1ad45000000';
        final attestationObject =
            TWData.createWithHexString(attestationHex).bytes()!;
        final publicKey = TWWebAuthn.getPublicKey(attestationObject);
      ...
      {
        const attestationHex =
            '0xa16861757468446174615825f95bc73828ee210f9fd3bbe72d97908013b0a3759e9aea3d0ae318766cd2e1ad4500000000';
        final attestationObject =
            TWData.createWithHexString(attestationHex).bytes()!;
        final publicKey = TWWebAuthn.getPublicKey(attestationObject);
        expect(publicKey.pointer, 0);
      ...
      {
        const attestationHex =
            '';
        final attestationObject =
            TWData.createWithHexString(attestationHex).bytes()!;
        final publicKey = TWWebAuthn.getPublicKey(attestationObject);
        expect(publicKey.pointer, 0);
      ...
      {
        const attestationHex =
            '0xa16861757468446174615858f95bc73828ee210f9fd3bbe72d97908013b0a3759e9aea3d0ae318766cd2e1ad4500000000adce000235bcc60a648b0b25f1f055030020c720eb493e167ce93183dd91f5661e1004ed8cc1be23d3340d92381da5c0c80ca5';
        final attestationObject =
            TWData.createWithHexString(attestationHex).bytes()!;
        expectWasmWithException(
            () => TWWebAuthn.getPublicKey(attestationObject).pointer, 0);
      }
    });
