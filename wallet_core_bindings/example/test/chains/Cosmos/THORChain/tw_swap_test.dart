  ...
  group('TWTHORChainSwap', () {
    test('SwapBtcToEth', () {
      ...
      // sign and encode resulting input
      {
        final output = Bitcoin.SigningOutput.fromBuffer(
            TWAnySigner.sign(txInput.writeToBuffer(), TWCoinType.Bitcoin));
    ...
    test('SwapEthBnb', () {
      ...
      final output = Ethereum.SigningOutput.fromBuffer(
          TWAnySigner.sign(txInput.writeToBuffer(), TWCoinType.Ethereum));
    ...
    test('SwapBnbBtc', () {
      ...
      // sign and encode resulting input
      final output = Ethereum.SigningOutput.fromBuffer(
          TWAnySigner.sign(txInput.writeToBuffer(), TWCoinType.Binance));
      expectHex(output.encoded,
    ...
    test('SwapAtomBnb', () {
      ...
      final output = Cosmos.SigningOutput.fromBuffer(
          TWAnySigner.sign(txInput.writeToBuffer(), TWCoinType.Cosmos));
