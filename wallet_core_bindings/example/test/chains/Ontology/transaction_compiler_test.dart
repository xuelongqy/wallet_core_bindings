...
void main() {
  ...
  group('OntologyCompiler', () {
    ...
    test('CompileWithSignatures', () {
      ...
      {
        expect(
          publicKey.verify(ontSignature, Uint8List.fromList(ontPreImageHash)),
          true,
        );
        expect(
          publicKey.verify(ongSignature, Uint8List.fromList(ongPreImageHash)),
          true,
        );
      }
      ...
      final oepPublicKey = TWPublicKey.createWithData(
          oepPublicKeyData, TWPublicKeyType.NIST256p1);
      ...
      expect(
        oepPublicKey.verify(oepSignature, Uint8List.fromList(oepPreImageHash)),
        true,
      );
