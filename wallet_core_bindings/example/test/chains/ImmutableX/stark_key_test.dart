...
const gLayer = "starkex";
const gApplication = "immutablex";
const gIndex = "1";
...
void main() {
  ...
  group('ImmutableX', () {
    ...
    test('SimpleSign', () {
      ...
      final signature = hex(privKey.sign(digest, TWCurve.Starkex));
    ...
    test('VerifySign', () {
      // valid
      {
        ...
        final signature = parse_hex(
            "061ec782f76a66f6984efc3a1b6d152a124c701c00abdd2bf76641b4135c770f04e44e759cea02c23568bb4d8a09929bbca8768ab68270d50c18d214166ccd9a");
        final pubKey =
            TWPublicKey.createWithData(pubKeyData, TWPublicKeyType.Starkex);
        expect(pubKey.verify(signature, hash), true);
      }
      ...
      // invalid
      {
        ...
        final pubKey =
            TWPublicKey.createWithData(pubKeyData, TWPublicKeyType.Starkex);
        expect(pubKey.verify(signature, hash), false);
      }
    });
  });
}
