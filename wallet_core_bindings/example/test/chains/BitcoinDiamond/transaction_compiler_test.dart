...
void main() {
  ...
  group('BitcoinDiamondCompiler', () {
    ...
    test('CompileWithSignatures', () {
      ...
      const amount = 196007725;
      const fee = 1014;
      const toAddress = '39mKL9gxk29f2RiofywHYRDmgXPv1ur8uC';
      ...
      const utxoAddr0 = "15ehpdrZqfZ5rj2e4T4hZKMi3kA8qdSyQu";
      ...
      expect(publicKey.verifyAsDER(signature, Uint8List.fromList(preImageHash)),
          true);
