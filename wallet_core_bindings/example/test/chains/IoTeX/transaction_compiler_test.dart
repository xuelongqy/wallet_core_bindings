...
void main() {
  ...
  group('TransactionCompiler', () {
    ...
    test('IoTeXCompileWithSignatures', () {
      ...
      final pbkey0 =
          prkey0.getPublicKeyByType(TWPublicKeyType.SECP256k1Extended);

      final prkey1 = TWPrivateKey.createWithData(privateKey1);
      final pbkey1 =
          prkey1.getPublicKeyByType(TWPublicKeyType.SECP256k1Extended);
      ...
      expect(
        pbkey0.verify(signature, Uint8List.fromList(preImageHash)),
        true,
      );
