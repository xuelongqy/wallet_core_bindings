...
Bitcoin.SigningInput buildInputP2PKH([bool omitKey = false]) {
  ...
  final pubKey1 = utxoKey1.getPublicKeyByType(TWPublicKeyType.SECP256k1);
...
Bitcoin.SigningInput buildInputP2WPKH(
    int amount, TWBitcoinSigHashType hashType, int utxo0Amount, int utxo1Amount,
...
Bitcoin.SigningInput buildInputP2WSH(TWBitcoinSigHashType hashType,
  ...
  if (!omitScript) {
    ...
    const scriptHash = '593128f9f90e38b706c18623151e37d2da05c229';
...
void main() {
  ...
  group('BitcoinSigning', () {
    test('SpendMinimumAmountP2WPKH', () {
      ...
      final myPublicKey =
          myPrivateKey.getPublicKeyByType(TWPublicKeyType.SECP256k1);
...

      {
        ...
        final plan = Bitcoin.TransactionPlan.fromBuffer(
            TWAnySigner.plan(input.writeToBuffer(), TWCoinType.Bitcoin));
      ...
      final result = Bitcoin.SigningOutput.fromBuffer(
          TWAnySigner.sign(input.writeToBuffer(), TWCoinType.Bitcoin));
    ...
    test('ExtraOutputs', () {
      final privateKey = TWData.createWithHexString(
          ...
          .bytes()!;
      const ownAddress = '1MhdctqCwYMn2DT4mshpwvYtfF98wBojXS';
      const toAddress = '1PRuxNSZwUXym6A31kmrArdT2BGJiTna19';
      const utxoAmount = 10000;
      const toAmount = 2000;
      const byteFee = 6;
      final utxoScript =
          TWBitcoinScript.lockScriptForAddress(ownAddress, TWCoinType.Bitcoin);
      final utxoHash = TWData.createWithHexString(
      ...
      final plan = Bitcoin.TransactionPlan.fromBuffer(
          TWAnySigner.plan(signingInput.writeToBuffer(), TWCoinType.Bitcoin));
      ...
      final output = Bitcoin.SigningOutput.fromBuffer(
          TWAnySigner.sign(signingInput.writeToBuffer(), TWCoinType.Bitcoin));
    ...
    test('ExtraOutputsRequireExtraInputs', () {
      ...
      const ownAddress = '1MhdctqCwYMn2DT4mshpwvYtfF98wBojXS';
      const toAddress = '1PRuxNSZwUXym6A31kmrArdT2BGJiTna19';
      const utxo0Amount = 10000;
      const utxo1Amount = 3000;
      const toAmount = 5999;
      const byteFee = 6;
    ...
    test('SignMaxAmount', () {
      ...
      const initialAmount = 10189533;
      const availableAmount = 10189534;
      const fee = 110;
      const amountWithoutFee = availableAmount - fee;
...
// https://www.zetachain.com/docs/developers/omnichain/bitcoin/#example-1-deposit-btc-into-an-account-in-zevm
    test('SignDepositBtcToZetaChain', () {
      ...
      const ownAddress = "bc1q2sphzvc2uqmxqte2w9dd4gzy4sy9vvfv0me9ke";
      ...
      const zetaTssAddress = "bc1qm24wp577nk8aacckv8np465z3dvmu7ry45el6y";

      final utxoHash0 = parse_hex(
              "17a6adb5db1e33c87467a58aa31cddbb3800052315015cf3cf1c2b0119310e20")
          .reversed
          .toList();
      const utxoAmount0 = 20000;
      const utxoOutputIndex0 = 0;
    ...
    test('SignP2WPKH_Bip143', () {
      ...
      input.plan = Bitcoin.TransactionPlan(
        ...
        fee: $fixnum.Int64(265210000),
        // very large, the amounts specified (in1, out0, out1) are not consistent/realistic
        change: $fixnum.Int64(223450000),
        // 0x0d519390
        branchId: [0],
        utxos: [
          utxo0,
    ...
    test('SignP2WPKH', () {
      final input = buildInputP2WPKH(
          335790000, TWBitcoinSigHashType.All, 625000000, 600000000);
    ...
    test('SignP2WPKH_HashSingle_TwoInput', () {
      final input = buildInputP2WPKH(
          335790000, TWBitcoinSigHashType.Single, 210000000, 210000000);
    ...
    test('SignP2WPKH_HashAnyoneCanPay_TwoInput', () {
      final input = buildInputP2WPKH(
          335790000, TWBitcoinSigHashType.AnyoneCanPay, 210000000, 210000000);
    ...
    test('SignP2WPKH_MaxAmount', () {
      final input = buildInputP2WPKH(
          1000, TWBitcoinSigHashType.All, 625000000, 600000000, true);
    ...
    test('SignP2WSH', () {
      // Setup input
      final input =
          buildInputP2WSH(TWBitcoinScript.hashTypeForCoin(TWCoinType.Bitcoin));
    ...
    test('SignP2SH_P2WSH', () {
      ...
      const expected = "01000000" // version
          "0001" // marker & flag
          "01" // inputs
          "36641869ca081e70f394c6948e8af409e18b619df2ed74aa106c1ca29787b96e"
          "01000000"
    ...
    test('Plan_10input_MaxAmount', () {
      const ownAddress = "bc1q0yy3juscd3zfavw76g4h3eqdqzda7qyf58rj4m";
      const ownPrivateKey =
          "eb696a065ef48a2192da5b28b694f87544b30fae8327c4510137a922f32c6dcf";
    ...
    test('PlanAndSign_LitecoinReal_8435', () {
      ...
      const ownAddress = "ltc1q0dvup9kzplv6yulzgzzxkge8d35axkq4n45hum";
      const ownPrivateKey =
    ...
    test('RedeemExtendedPubkeyUTXO', () {
      const wif = "L4BeKzm3AHDUMkxLRVKTSVxkp6Hz9FcMQPh18YCKU1uioXfovzwP";
      final decoded = TWBase58.decode(wif)!;
      final key = TWPrivateKey.createWithData(decoded.sublist(1, 33));
      final pubkey = key.getPublicKeyByType(TWPublicKeyType.SECP256k1Extended);
      ...
      final utxo0Script = TWBitcoinScript.lockScriptForAddress(
          addressString, TWCoinType.Bitcoin);
    ...
    test('SignP2TR_5df51e', () {
      ...
      const ownAddress = "bc1qpjult34k9spjfym8hss2jrwjgf0xjf40ze0pp8";
      const toAddress =
      ...
      expect(
          TWSegwitAddress.createWithPublicKey(TWHRP.forString('bc'), pubKey0)
              .description,
          ownAddress);
      final utxoPubkeyHash = TWHash.ripemd(TWHash.sha256(pubKey0.data));
    ...
    test('Sign_OpReturn_THORChainSwap', () {
      ...
      final ownAddress =
          TWSegwitAddress.createWithPublicKey(TWHRP.forString('bc'), publicKey);
      final ownAddressString = ownAddress.description;
      expect(ownAddressString, 'bc1q2gzg42w98ytatvmsgxfc8vrg6l24c25pydup9u');
      const toAddress = 'bc1qxu5a8gtnjxw3xwdlmr2gl9d76h9fysu3zl656e';
      const utxoAmount = 342101;
      const toAmount = 300000;
      int byteFee = 126;
