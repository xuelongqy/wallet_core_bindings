  ...
  group(TWTransactionCompiler, () {
    test('ExternalSignatureSignBinance', () {
      ...
      final publicKeyData = TWData.createWithHexString(
          ...
          .bytes()!;
      final publicKey =
          TWPublicKey.createWithData(publicKeyData, TWPublicKeyType.SECP256k1);
      ...
      {
        expect(publicKey.verify(signature, preImageHashData), true);
      }
    ...
    test('ExternalSignatureSignEthereum', () {
      ...
      {
        expect(
          publicKey.verify(signature, preImageHashData),
          true,
        );
      }
    ...
    test('ExternalSignatureSignBitcoin', () {
      ...
      for (final h in hashes) {
        ...
        // Verify signature (pubkey & hash & signature)
        expect(publicKey.verifyAsDER(signature, preImageHash_), true);
      }
    ...
    test('ExternalSignatureSignSolana', () {
      ...
      /// Step 1: Prepare transaction input (protobuf)
      const recipient = '3UVYmECPPMZSCqWKfENfuoTv51fTDTWicX9xmBD2euKe';
      const sender = 'sp6VUqq1nDEuU83bU2hstmEYrJNipJYpwS7gZ7Jv7ZH';
      ...
      // Verify signature (pubkey & hash & signature)
      expect(publicKey.verify(signature, preImageHash), true);
    ...
    test('ExternalSignatureSignNULS', () {
      ...
      /// Step 1: Prepare transaction input (protobuf)
      const form = 'NULSd6HgWabfcG6H7NDK2TJvtoU3wxY1YLKwJ';
    ...
    test('ExternalSignatureSignNULSToken', () {
      ...
      const amount = 10000000;
      const balance = 100000000;
      const feePayerBalance = 100000000;
      const nonce = '0000000000000000';
      final input = NULS.SigningInput(
        from: from,
        to: to,
