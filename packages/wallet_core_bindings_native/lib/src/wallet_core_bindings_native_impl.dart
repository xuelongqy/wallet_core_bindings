...
class WalletCoreBindingsNativeImpl extends WalletCoreBindingsInterface {
  ...
  Future initialize() async {
    ...
    biz = TWBizImpl(_bindings);
    bizPasskeySession = TWBizPasskeySessionImpl(_bindings);
    base32 = TWBase32Impl(_bindings);
    base58 = TWBase58Impl(_bindings);
    base64 = TWBase64Impl(_bindings);
    bech32 = TWBech32Impl(_bindings);
    ...
    eip7702 = TWEip7702Impl(_bindings);
    ...
    messageSigner = TWMessageSignerImpl(_bindings);
    ...
    webAuthnSolidity = TWWebAuthnSolidityImpl(_bindings);
