...
class TransactionInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'prevHash', $pb.PbFieldType.OY)
    ..aI(2, _omitFieldNames ? '' : 'prevIndex', fieldType: $pb.PbFieldType.OF3)
...
class OutputAddress extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OS6,
...
class TransactionOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<OutputAddress>(5, _omitFieldNames ? '' : 'extraOutputs',
...
class Transaction_Nep5Transfer extends $pb.GeneratedMessage {
  factory Transaction_Nep5Transfer({
    ...
    if (amount != null) result.amount = amount;
    if (scriptWithRet != null) result.scriptWithRet = scriptWithRet;
    return result;
  }

  Transaction_Nep5Transfer._();

  factory Transaction_Nep5Transfer.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Transaction_Nep5Transfer.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Transaction.Nep5Transfer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'assetId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Transaction_Nep5Transfer clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Transaction_Nep5Transfer copyWith(
          void Function(Transaction_Nep5Transfer) updates) =>
      super.copyWith((message) => updates(message as Transaction_Nep5Transfer))
          as Transaction_Nep5Transfer;
  ...
  @$core.pragma('dart2js:noInline')
  static Transaction_Nep5Transfer getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Transaction_Nep5Transfer>(create);
  ...
  @$pb.TagNumber(5)
  set scriptWithRet($core.bool value) => $_setBool(4, value);
  @$pb.TagNumber(5)
  $core.bool hasScriptWithRet() => $_has(4);
  @$pb.TagNumber(5)
  void clearScriptWithRet() => $_clearField(5);
}
...
class Transaction_InvocationGeneric extends $pb.GeneratedMessage {
  ...
  Transaction_InvocationGeneric._();

  factory Transaction_InvocationGeneric.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Transaction_InvocationGeneric.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Transaction.InvocationGeneric',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'gas', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Transaction_InvocationGeneric clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Transaction_InvocationGeneric copyWith(
          void Function(Transaction_InvocationGeneric) updates) =>
      super.copyWith(
              (message) => updates(message as Transaction_InvocationGeneric))
          as Transaction_InvocationGeneric;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Transaction_InvocationGeneric create() =>
      Transaction_InvocationGeneric._();
  @$core.override
  Transaction_InvocationGeneric createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static Transaction_InvocationGeneric getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Transaction_InvocationGeneric>(create);
...
enum Transaction_TransactionOneof { nep5Transfer, invocationGeneric, notSet }
...
class Transaction extends $pb.GeneratedMessage {
  factory Transaction({
    ...
    final result = create();
    if (nep5Transfer != null) result.nep5Transfer = nep5Transfer;
    if (invocationGeneric != null) result.invocationGeneric = invocationGeneric;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Transaction_Nep5Transfer>(1, _omitFieldNames ? '' : 'nep5Transfer',
        subBuilder: Transaction_Nep5Transfer.create)
    ..aOM<Transaction_InvocationGeneric>(
        2, _omitFieldNames ? '' : 'invocationGeneric',
        subBuilder: Transaction_InvocationGeneric.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set nep5Transfer(Transaction_Nep5Transfer value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasNep5Transfer() => $_has(0);
  @$pb.TagNumber(1)
  void clearNep5Transfer() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set invocationGeneric(Transaction_InvocationGeneric value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasInvocationGeneric() => $_has(1);
  @$pb.TagNumber(2)
  void clearInvocationGeneric() => $_clearField(2);
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..pPM<TransactionInput>(1, _omitFieldNames ? '' : 'inputs',
        subBuilder: TransactionInput.create)
    ..pPM<TransactionOutput>(2, _omitFieldNames ? '' : 'outputs',
    ...
    ..aOM<TransactionPlan>(7, _omitFieldNames ? '' : 'plan',
        subBuilder: TransactionPlan.create)
    ..aOM<Transaction>(8, _omitFieldNames ? '' : 'transaction',
  ...
  @$pb.TagNumber(8)
  set transaction(Transaction value) => $_setField(8, value);
  @$pb.TagNumber(8)
...
class TransactionOutputPlan extends $pb.GeneratedMessage {
  ...
  factory TransactionOutputPlan.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransactionOutputPlan.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransactionOutputPlan',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ...
    ..pPM<OutputAddress>(7, _omitFieldNames ? '' : 'extraOutputs',
        subBuilder: OutputAddress.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransactionOutputPlan clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  /// extra output
  @$pb.TagNumber(7)
  $pb.PbList<OutputAddress> get extraOutputs => $_getList(6);
}
...
class TransactionAttributePlan extends $pb.GeneratedMessage {
  ...
  TransactionAttributePlan._();

  factory TransactionAttributePlan.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransactionAttributePlan.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransactionAttributePlan',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'usage')
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'data', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransactionAttributePlan clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransactionAttributePlan copyWith(
          void Function(TransactionAttributePlan) updates) =>
      super.copyWith((message) => updates(message as TransactionAttributePlan))
          as TransactionAttributePlan;
  ...
  @$core.pragma('dart2js:noInline')
  static TransactionAttributePlan getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransactionAttributePlan>(create);
  static TransactionAttributePlan? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get usage => $_getIZ(0);
  @$pb.TagNumber(1)
  set usage($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NEO.Proto'),
      createEmptyInstance: create)
    ..pPM<TransactionOutputPlan>(1, _omitFieldNames ? '' : 'outputs',
        subBuilder: TransactionOutputPlan.create)
    ..pPM<TransactionInput>(2, _omitFieldNames ? '' : 'inputs',
        subBuilder: TransactionInput.create)
    ..aInt64(3, _omitFieldNames ? '' : 'fee')
    ..aE<$0.SigningError>(4, _omitFieldNames ? '' : 'error',
        enumValues: $0.SigningError.values)
    ..pPM<TransactionAttributePlan>(5, _omitFieldNames ? '' : 'attributes',
        subBuilder: TransactionAttributePlan.create)
    ..hasRequiredFields = false;
  ...
  /// Attribute
  @$pb.TagNumber(5)
  $pb.PbList<TransactionAttributePlan> get attributes => $_getList(4);
}
