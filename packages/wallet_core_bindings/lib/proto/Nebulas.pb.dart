...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'TW.Nebulas.Proto'),
    ...
    ..a<$core.List<$core.int>>(
        7, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        8, _omitFieldNames ? '' : 'timestamp', $pb.PbFieldType.OY)
    ..aOS(9, _omitFieldNames ? '' : 'payload')
    ..a<$core.List<$core.int>>(
        10, _omitFieldNames ? '' : 'privateKey', $pb.PbFieldType.OY)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'TW.Nebulas.Proto'),
      createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'algorithm', fieldType: $pb.PbFieldType.OU3)
    ..a<$core.List<$core.int>>(
...
class RawTransaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'from', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'to', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
    ...
    ..aI(8, _omitFieldNames ? '' : 'chainId', fieldType: $pb.PbFieldType.OU3)
    ..a<$core.List<$core.int>>(
        9, _omitFieldNames ? '' : 'gasPrice', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        10, _omitFieldNames ? '' : 'gasLimit', $pb.PbFieldType.OY)
    ..aI(11, _omitFieldNames ? '' : 'alg', fieldType: $pb.PbFieldType.OU3)
    ..a<$core.List<$core.int>>(
        12, _omitFieldNames ? '' : 'sign', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
