...
class TWMnemonic {
  ...
  static bool isValid(String mnemonic) =>
      _mnemonicImpl.isValid(TWString(mnemonic).pointer);
  ...
  static bool isValidWord(String word) =>
      _mnemonicImpl.isValidWord(TWString(word).pointer);
  ...
  static String suggest(String word) =>
      TWString.fromPointer(_mnemonicImpl.suggest(TWString(word).pointer))
          .value!;
}
