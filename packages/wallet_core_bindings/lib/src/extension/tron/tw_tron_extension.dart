...
/// Tron extension
extension TWTronExtension on $tron.SigningInput {
  /// Sign
  /// \param [coin] coin type
  /// \return Tron `SigningOutput` proto object.
  $tron.SigningOutput sign([
    TWCoinType coin = TWCoinType.Tron,
  ]) {
    return anySignToOutput(coin, $tron.SigningOutput());
  }
  ...
  /// \return Tron `SigningOutput` proto object.
  $tron.SigningOutput compileWithSignatures({
    TWCoinType coin = TWCoinType.Tron,
