...
/// FIO extension
extension TWFIOExtension on $fio.SigningInput {
  /// Sign
  /// \param [coin] coin type
  /// \return FIO `SigningOutput` proto object.
  $fio.SigningOutput sign([
    TWCoinType coin = TWCoinType.FIO,
  ]) {
    return anySignToOutput(coin, $fio.SigningOutput());
  }
  ...
  /// \return FIO `SigningOutput` proto object.
  $fio.SigningOutput compileWithSignatures({
    TWCoinType coin = TWCoinType.FIO,
