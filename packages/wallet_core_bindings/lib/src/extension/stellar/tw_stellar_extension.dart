...
/// Stellar extension
extension TWStellarExtension on $stellar.SigningInput {
  /// Sign
  /// \param [coin] coin type
  /// \return Stellar `SigningOutput` proto object.
  $stellar.SigningOutput sign([
    TWCoinType coin = TWCoinType.Stellar,
  ]) {
    return anySignToOutput(coin, $stellar.SigningOutput());
  }
  ...
  /// \return Stellar `SigningOutput` proto object.
  $stellar.SigningOutput compileWithSignatures({
    TWCoinType coin = TWCoinType.Stellar,
