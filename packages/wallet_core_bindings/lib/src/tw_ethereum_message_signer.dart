...
class TWEthereumMessageSigner {
  ...
  static String signTypedMessage(TWPrivateKey privateKey, String messageJson) =>
      TWString.fromPointer(
        _ethereumMessageSignerImpl.signTypedMessage(
          privateKey.pointer,
  ...
  static String signTypedMessageEip155(
      ...
      TWString.fromPointer(
        _ethereumMessageSignerImpl.signTypedMessageEip155(
          privateKey.pointer,
          TWString(messageJson).pointer,
          chainId,
        ),
  ...
  static String signMessage(TWPrivateKey privateKey, String message) =>
      TWString.fromPointer(
        _ethereumMessageSignerImpl.signMessage(
          privateKey.pointer,
  ...
  static String signMessageImmutableX(
      ...
      TWString.fromPointer(
        _ethereumMessageSignerImpl.signMessageImmutableX(
          privateKey.pointer,
          TWString(message).pointer,
        ),
      ).value!;
  ...
  static String signMessageEip155(
      ...
      TWString.fromPointer(
        _ethereumMessageSignerImpl.signMessageEip155(
          privateKey.pointer,
          TWString(message).pointer,
          chainId,
        ),
  ...
  static bool verifyMessage(
      ...
      _ethereumMessageSignerImpl.verifyMessage(
        pubKey.pointer,
        TWString(message).pointer,
